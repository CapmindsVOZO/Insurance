...
public class Pageobjectmanager3 {
...
//	private Schedule_Negative st;
	...
	private Schedule_Modulelocators3 sm;

	public Pageobjectmanager3(WebDriver driver2) {
		this.driver = driver2;
...
//	}
	...
	public Schedule_Modulelocators3 getschedloc3() {

		if (sm == null) {

			sm = new Schedule_Modulelocators3(driver);
